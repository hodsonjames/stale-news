        ...
        for t in tickers:
            if (t, date) in mdatabase.tdMap:
                thread = threading.Thread(target=lambda q, arg1, arg2, arg3: q.put(
                    [percentageOld(arg1, arg2, arg3), np.log(stories(arg1, arg2, arg3)),
                     np.log(terms(arg1, arg2, arg3)), np.log(terms(arg1, arg2, arg3))**2]),
...
def abnormalPercentageRecombinationsParallel(firm, date, mdatabase):
    ...
    if date not in mdatabase.aprreg:
        ...
        for t in tickers:
            if (t, date) in mdatabase.tdMap:
                thread = threading.Thread(target=lambda q, arg1, arg2, arg3: q.put(
                    [percentageRecombinations(arg1, arg2, arg3), np.log(stories(arg1, arg2, arg3)),
                     np.log(terms(arg1, arg2, arg3)), np.log(terms(arg1, arg2, arg3))**2]),
                                          args=(dpoint_queue, t, date, mdatabase))
                thread.start()
                thread_list.append(thread)
...
def abnormalReturn(firm, dateStart, dateEnd, pdatabase, printWarnings=True):
    ...
    for i in range(dateEndInd - dateStartInd + 1):
        thread = threading.Thread(target=lambda q, arg1, arg2, arg3, arg4: q.put(
            abnormalReturnDate(arg1, arg2, arg3, arg4)),
...
def abnormalVolParallel(firm, dateStart, dateEnd, pdatabase, printWarnings=True):
    ...
    for i in range(dateEndInd - dateStartInd + 1):
        thread = threading.Thread(target=lambda q, arg1, arg2, arg3, arg4: q.put(
            abnormalVolDate(arg1, arg2, arg3, arg4)),
...
def allFirmsVolumeFrac(date, pdatabase, printWarnings=True):
    ...
    for tic in relevantFirms:
        ...
        thread = threading.Thread(target=lambda q, arg1, arg2, arg3: q.put(
            marketCap(arg1, arg2, arg3)*firmVolumeFrac(arg1, arg2, arg3)),
...
def abnormalStoriesParallel(firm, date, mdatabase):
    ...
    for i in range(60):
        if i < 55:
            thread = threading.Thread(target=lambda q, arg1, arg2, arg3: q.put(
                stories(arg1, arg2, arg3)), args=(s60to6_queue, firm, dates[dateLess60 + i], mdatabase,))
            thread.start()
            thread_list_60to6.append(thread)
        else:
            thread = threading.Thread(target=lambda q, arg1, arg2, arg3: q.put(
                stories(arg1, arg2, arg3)), args=(s5to1_queue, firm, dates[dateLess60 + i], mdatabase,))
            thread.start()
...
def totalMarketCap(date, pdatabase, printWarnings=True):
    ...
    thread_list = []
    for tic in tics:
        thread = threading.Thread(target=lambda q, arg1, arg2, arg3, arg4: q.put(marketCap(arg1, arg2, arg3, arg4)),
...
def abnormalVolatilityDate(firm, date, pdatabase, printWarnings=True):
    ...
    if (firm, str(pdatabase.dates[dateLess19])) in pdatabase.abnret:
        ...
        thread_list = []
        for i in range(dateInd - dateLess19 + 1):
            thread = threading.Thread(target=lambda q, arg1, arg2, arg3, arg4: q.put(abnormalReturnDate(arg1, arg2, arg3, arg4)),
...
def illiquidity(firm, dateStart, dateEnd, pdatabase, printWarnings=True):
    ...
    for i in range(dateEndInd - dateStartInd + 1):
        thread = threading.Thread(target=lambda q, arg1, arg2, arg3, arg4: q.put(
            illiquidityMeasureDate(arg1, arg2, arg3, arg4)),
...
def generateXListParallel(firm, date, mdatabase, pdatabase1, pdatabase2, printWarnings=True):
    ...
    if printWarnings:
        print("Entry 5 Computing...")
    thread = threading.Thread(target=lambda d, arg1, arg2, arg3, arg4, arg5: d.update({5: abnormalReturn(arg1, arg2, arg3, arg4, arg5)}),
    ...
    if printWarnings:
        print("Entry 6 Computing...")
    thread = threading.Thread(target=lambda d, arg1, arg2, arg3, arg4, arg5: d.update({6: abnormalVol(arg1, arg2, arg3, arg4, arg5)}),
                              args=(five_eight_dict, firm, dateStartLess5, dateEndLess1, pdatabase1, printWarnings))
    thread.start()
    thread_list.append(thread)
    # 7
    if printWarnings:
        print("Entry 7 Computing...")
    thread = threading.Thread(target=lambda d, arg1, arg2, arg3, arg4, arg5: d.update({7: abnormalVolatility(arg1, arg2, arg3, arg4, arg5)}),
                              args=(five_eight_dict, firm, dateStartLess5, dateEndLess1, pdatabase1, printWarnings))
    thread.start()
    thread_list.append(thread)
    # 8
    if printWarnings:
        print("Entry 8 Computing...")
    thread = threading.Thread(target=lambda d, arg1, arg2, arg3, arg4, arg5: d.update({8: illiquidity(arg1, arg2, arg3, arg4, arg5)}),
                              args=(five_eight_dict, firm, dateStartLess5, dateEndLess1, pdatabase1, printWarnings))
    thread.start()
    thread_list.append(thread)
    for t in thread_list:
